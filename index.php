    ...
    <div class="website">
        <header>
            ...
            <ul class="list-navbar">
                <li class="list-navbar--item">Now Playing</li>
                <li class="list-navbar--item">Popular</li>
                <li class="list-navbar--item">Top Rated</li>
                <li class="list-navbar--item">Upcoming</li>
            </ul>
        </header>
        <div class="body-container">
                    ...
                    while($row = mysqli_fetch_assoc($result)){ ?>
                        <div class="item-movie">
                            ...
                            <div class="content-movie">
                                <h2 class="movie-main--title"><?php echo $row['movie_name']?></h2>
                                <p class="movie-year--release"><i><?php echo $row['release_date']?></i></p>
                            </div>
                        </div>
                    <?php } }else{
                                echo "0 result";
            ...
            <div class="pagination">
                <div class="pagination-item" style="border-top-left-radius: 10px;
    border-bottom-left-radius: 10px;">Previous</div>
                <div class="pagination-item">1</div>
                <div class="pagination-item">2</div>
                <div class="pagination-item">3</div>
                <div class="pagination-item">4</div>
                <div class="pagination-item" style="border-top-right-radius: 10px;
    border-bottom-right-radius: 10px;">Next</div>
            </div>
        </div>
    </div>
</body>
